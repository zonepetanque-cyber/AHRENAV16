...
const DEPT_SOURCES: DeptSource[] = [
  ...
  { dept: "L'Équipe", code: 'MEDIA', color: '#e8000d', active: true, siteUrl: 'https://www.lequipe.fr', rssUrls: ['https://www.lequipe.fr/rss/actu_rss.xml'], filterKeywords: ['pétanque','petanque','boules','bouliste','jeu provençal','sport-boules','sport boules'] },
